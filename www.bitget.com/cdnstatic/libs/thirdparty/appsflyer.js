  ...
  function (e, n, t) {
    window.AF.plugins.PBA = (function () {
      ...
      function setMeasurementStatus(e, n) {
        try {
          return new Promise(function (t) {
            return window.AF_SDK.PLUGINS.PBA.coverDomain
              ...
              : window.AF_SDK.xhr({
                  url:
                    "https://wa.appsflyer.com/coverdomain?site-id=" +
                    getWebAppId(),
          ...
          return window.AF_SDK.utils.logger(
            "Error occur in setMeasurementStatus function (main catch) after ",
            e
          );
        }
      }
      ...
      function waHandlerRequest(e, n) {
        ...
        var t = !e.afWebUserId;
        return (
          window.AF_SDK.PLUGINS.PBA.makeRequest(e, n, t),
          !t &&
            !window.AF_SDK.PLUGINS.PBA.QHandler &&
            window.AF_SDK.PLUGINS.PBA.emptyQ(window.AF_SDK.Q)
        );
      }
      function addClientHints(e, n) {
        return new Promise(function (t) {
          if (
            ...
            var r = window.AF_SDK.PLUGINS.PBA.afSync.createDeferred(
              navigator.userAgentData.getHighEntropyValues([
                "architecture",
                "bitness",
                "mobile",
      ...
      function getAfWebUserId() {
        return window.AF_SDK.PLUGINS.PBA.afWebUserId
          ? window.AF_SDK.PLUGINS.PBA.afWebUserId
          : ((window.AF_SDK.PLUGINS.PBA.afWebUserId =
              window.AF_SDK.utils.cookie.get(e)),
            window.AF_SDK.PLUGINS.PBA.afWebUserId);
      ...
      function getAfUserIds() {
        var e =
          ...
          window.AF_SDK.PLUGINS.PBA.afSync.afUserIds;
        return (e && Object.keys(e).length && e) || null;
      }
      function getWebAppId() {
        return (
          window.AF_SDK.initPluginsConfig.pba &&
      ...
      function getLastInteraction() {
        return (
          Number(
            window.AF_SDK.utils.storage.getItem(window.AF_SDK.CONST.AF_SESSION)
          ) || 0
        );
      }
      function lastInteractionSync(e) {
        ...
        (e.meta.lastInteractionTimestamp = getLastInteraction() || n),
          (function updateLastInteraction(e) {
            window.AF_SDK.utils.storage.setItem(
              window.AF_SDK.CONST.AF_SESSION,
              e
            );
          })(n);
      }
      ...
      function invokeLoadEvent(e) {
        window.AF_SDK.PLUGINS.PBA.afSync.isSyncRequired()
          ? window.AF_SDK.PLUGINS.PBA.afSync
              .preLoadSync()
              .then(function () {
                completeAfSync(e);
              ...
              .catch(function (n) {
                window.AF_SDK.utils.logger(
                  "An error occurred on preLoadSync",
                  n
                ),
                  completeAfSync(e);
              })
      ...
      return (
        window.addEventListener
          ? window.addEventListener("beforeunload", setAfUserId, !1)
          : window.attachEvent
          ? window.attachEvent("onbeforeunload", setAfUserId)
          : (window.onbeforeunload = setAfUserId),
        {
          VERSION: "0.0.54",
          ...
          disableMeasurement: function disableMeasurement() {
            try {
              ...
              return window.AF_SDK.utils.logger(
                "Error occur in disableMeasurement function (main catch) after ",
                e
              );
            }
          },
          enableMeasurement: function enableMeasurement() {
            try {
              setMeasurementStatus(r, !0)
                .then(function whenOK() {
                  window.AF("pba", "load", { eventType: "LOAD" });
                })
                .catch(function onError(e) {
                  return window.AF_SDK.utils.logger(
                    "Error occur in enableMeasurement function",
                    e
                  );
                });
            } catch (e) {
              return window.AF_SDK.utils.logger(
                "Error occur in enableMeasurement function (main catch) after ",
                e
              );
            }
          },
                ...
                window.AF_SDK.xhr({
                  ...
                  cb: function (e) {
                    !(function waHandlerCbFn(e, n) {
                      ...
                      return (
                        t &&
                          ((window.AF_SDK.PLUGINS.PBA.afWebUserId = t),
                          setAfUserIdCookie(t)),
                        n &&
                          !window.AF_SDK.PLUGINS.PBA.QHandler &&
                          window.AF_SDK.PLUGINS.PBA.emptyQ(window.AF_SDK.Q)
            ...
            try {
              ...
              if ("boolean" == typeof t)
                setMeasurementStatus(o, t)
                  ...
                  .catch(function onError(e) {
                    return window.AF_SDK.utils.logger(
                      "Error occur in load function after ",
                      e
                    );
                  });
              else {
                var r = window.AF_SDK.PLUGINS.PBA.getMeasurementStatus();
                if (!e || !e.data || !r) return;
                lastInteractionSync(e),
                  setWebAppIdQueryParam(),
                  invokeLoadEvent(e);
              }
              ...
              return window.AF_SDK.utils.logger(
                "Error occur in load function (main catch) after ",
                e
              );
            }
          },
          event: function (e) {
            try {
              ...
              return (
                e.data.eventValue &&
                  window.AF_SDK.utils.isObject(e.data.eventValue) &&
                  (e.data.eventValue = window.AF_SDK.utils.tcJSON(
                    e.data.eventValue,
                    "stringify"
                  )),
              ...
              return window.AF_SDK.utils.logger(
                "Error occur in event function (main catch) after ",
                e
              );
            }
          },
            ...
            try {
              ...
              var t = (function transformSetCustomerUserIdParamsToSchema(e) {
                try {
                  ...
                  return void window.AF_SDK.utils.logger(
                    "Error occur in transformSetCustomerUserIdParamsToSchema function (main catch) after ",
                    e
                  );
                }
              })(e);
              ...
              return window.AF_SDK.utils.logger(
                "Error occur in setCustomerUserId function (main catch) after ",
                e
              );
            }
          },
          emptyQ: function (e) {
            if (
              window.AF_SDK.PLUGINS.PBA.afWebUserId &&
              window.AF_SDK.Q.length &&
              (function checkPbaQ(e) {
                if (window.AF_SDK.PLUGINS.PBA.QHandler) return !1;
              ...
              return (
                (window.AF_SDK.PLUGINS.PBA.QHandler = !0),
                window.AF_SDK.BASE.emptyQ(e, "pba")
              );
          },
          turnOnDevMode: function () {
            window.AF_SDK.utils.cookie.set(
              "AF_DEV_MODE",
              Date.now().toString(),
              {
  ...
  function (e, n, t) {
    ...
    e.exports = (function () {
      ...
      function createTimeoutPromise(e) {
        ...
        return { timeoutId: n, promise: r };
      }
      function makeExpiringPromise(e, n) {
        var t = Array.isArray(e.promise) ? Promise.all(e.promise) : e.promise,
          r = createTimeoutPromise(n);
        return Promise.race([r.promise, t])
          .then(function (n) {
            e.resolve && e.resolve(n), clearTimeout(r.timeoutId);
          })
          .catch(function (n) {
            e.reject && e.reject(n), clearTimeout(r.timeoutId);
          });
      }
      ...
      return {
        afUserIds: {},
        preloadCompleted: !1,
        vendorsConfig: { olWebUserId: "https://wa.onelink.me/v1/onelink" },
          ...
          return new Promise(function (r) {
            try {
              ...
              if (!o || !o.length)
                return (
                  window.AF_SDK.utils.logger(
                    "Invalid afSync vendor config. vendorId: " + e
                  ),
                  r(!1)
                );
              ...
              window.AF_SDK.xhr({
                ...
                cb: function (n) {
                  var t = window.AF_SDK.PLUGINS.PBA.afSync.syncRequestCallback(
                    e,
                    n
                  );
                  r(t);
              ...
              window.AF_SDK.utils.logger(
                "An error occurred during sync vendorId: " + e,
                n
              ),
                r(!1);
            }
        ...
        syncRequestCallback: function syncRequestCallback(e, t) {
          try {
            return t.data && Object.prototype.hasOwnProperty.call(t.data, n)
              ? (t.data[n].length &&
                  (window.AF_SDK.PLUGINS.PBA.afSync.afUserIds[e] = t.data[n]),
                !0)
              : (window.AF_SDK.utils.logger(
                  "Received invalid sync response. vendorId: " + e,
                  t.data
                ),
                !1);
          } catch (n) {
            return (
              window.AF_SDK.utils.logger(
                "An error occurred on sync response cb. vendorId: " + e,
                n
              ),
              !1
            );
        ...
        preLoadSync: function preLoadSync() {
          return new Promise(function (e, n) {
            ...
            makeExpiringPromise(
              window.AF_SDK.PLUGINS.PBA.afSync.createDeferred(
                i,
                function (t) {
                  if (
                    t.some(function (e) {
                  ...
                  (window.AF_SDK.PLUGINS.PBA.afSync.preloadCompleted = !0), e();
                },
                function (e) {
                  (window.AF_SDK.PLUGINS.PBA.afSync.preloadCompleted = !1),
                    n(e);
        ...
        postLoadSync: function postLoadSync() {
          return new Promise(function (e, n) {
            ...
            if (!r) return n(new Error("afWebUserId does not exist"));
            var o = window.AF_SDK.PLUGINS.PBA.afSync.vendorsConfig,
              ...
              a = Object.keys(o)
                ...
                .map(function (e) {
                  return window.AF_SDK.PLUGINS.PBA.afSync.buildSyncRequest(
                    e,
                    r
                  );
                });
            if (!a || !a.length) return setSyncCookie(), e();
            makeExpiringPromise(
              window.AF_SDK.PLUGINS.PBA.afSync.createDeferred(
                a,
                function (n) {
                  window.AF_SDK.PLUGINS.PBA.afSync.preloadCompleted &&
                    !n.some(function (e) {
                      return !e;
                    }) &&
...
!(function (e) {
  ...
  function (e, t, r) {
    ...
    e.exports = {
      after: function _after(e, t) {
        if (e < 0) throw new Error("Invalid argument count");
        if ("function" != typeof t)
          throw new Error("Invalid argument callback");
        var r = [];
        return function () {
          var n = Array.prototype.slice.call(arguments);
          if ((r.push(n), 0 == (e -= 1))) return t(r);
        };
      },
      pickUrlValues: function _pickUrlValues(e) {
        var t,
          r = [];
        for (var n in e)
          e.hasOwnProperty(n) && ((t = e[n]), a.test(t)) && r.push(e[n]);
        return r;
      },
      timeLimitCallback: function _timeLimitCallback(e, t, r) {
        ...
        return function () {
          window.clearTimeout(i), n || t.apply(this, arguments);
        };
      },
      ...
      setUpdateParams: function _setUpdateParams(e) {
        ...
        t
          ? ((i = Object.assign({}, t)),
            window.AF_SDK.utils.logger("update params - success"))
          : window.AF_SDK.utils.logger(
              "update params - failure: the sent parameters are invalid"
            );
      },
      ...
      _getClientHints: function _getClientHints(e) {
        if (_isUACHSupported())
          try {
            ...
            window.AF_SDK.utils.logger(
              "An error occurred trying getting client hints",
              t
            ),
              e && e();
          }
  ...
  function (e, t, r) {
    ...
    function generateUTMParams(e, t) {
      return Object.assign(
        {},
        e && t ? { c: e } : {},
        t ? { pid: t, af_banner_build: "utm" } : { af_banner_build: "static" },
        { af_banner_config: "utm" }
      );
    }
    var u = { af_channel: "af_web_banner", pid: "af_banner" },
      c = ["af_banner", "af_banner_sdk_ver"];
    e.exports = {
      initSession: function _initSession() {
        window.AF_SDK.utils.session.getItem(o) ||
          window.AF_SDK.utils.session.setItem(
            o,
      ...
      updateUrlQueryStorage: function _updateUrlQueryStorage() {
        ...
        l
          ? (window.AF_SDK.utils.storage.setItem(s, location.search),
            window.AF_SDK.utils.storage.setItem(d, new Date().getTime() + 72e5))
          : u &&
            u < new Date() &&
            (window.AF_SDK.utils.storage.removeItem(d),
            window.AF_SDK.utils.storage.removeItem(s));
      },
      canDisplayBanner: function _canDisplayBanner(e) {
        var t =
            -1 !== e.frequency_capping &&
            (window.AF_SDK.utils.storage.getItem(i, {})[e.id] || 0) >=
              e.frequency_capping,
          r = !1,
      ...
      updateBannerDismissalInfo: function _updateBannerDismissalInfo(e) {
        ...
        "nextSession" === e.dismissal.type
          ? (t[e.id] = window.AF_SDK.utils.session.getItem(o))
          : (t[e.id] = new Date().getTime().toString()),
          window.AF_SDK.utils.storage.setItem(a, t);
      },
      updateBannerFrequencyCapping: function _updateBannerFrequencyCapping(
        e,
        t
      ) {
      ...
      buildUrlQueryString: function _buildUrlQueryString(e, t, r) {
        for (
          var i = (function _extractDynamicParams(e) {
              var t = window.AF_SDK.utils.storage.getItem(s) || "",
                r = window.AF_SDK.utils.getUrlParamsObject({ search: t }),
                n = r.utm_source,
                i = r.utm_campaign,
                a = r.gclid,
                o = r.fbclid,
            ...
            a = n.getAdditionalParams(),
            o = n.getUpdateParams(),
            d = Object.assign({}, o, u, e.url.params, a, i),
            l = 0;
          l < c.length;
          l++
        )
        ...
        return (
          ...
          r &&
            ((d.af_ch_model = encodeURIComponent(r.model)),
      ...
      isSDKDisabled: function _isSDKDisabled() {
        return (
          "true" === window.AF_SDK.utils.getUrlParamsObject({})["af-sb-disable"]
        );
      },
  ...
  function (e, t, r) {
    ...
    function _init() {
      s.initSession(), s.updateUrlQueryStorage();
    }
      ...
      var r = a.prefetchAssets(e.creative.prefetch_urls, function (r) {
        if (r)
          ...
          try {
            ...
            d.injectPixel(e), u.push(n);
            var i = document.body.querySelector("[data-af-cta-button]");
            (document.body.querySelector("[data-af-close-button]").onclick =
              (function _getHideBannerHandler(e, t, r) {
                return !r && t.dismissal
                  ? function () {
                      s.updateBannerDismissalInfo(t), _hideBanner();
                    }
                  : _hideBanner;
              })(0, e, t.preview)),
              ...
              (i.onclick = (function _getBannerClickedHandler(e, t) {
                return function (r) {
                  var n = e.url.path + s.buildUrlQueryString(e, t),
                    i = "";
                  if (
                    (window.AF_SDK.utils.logger("oneLink URL: " + n),
                    window.AF_SDK.PLUGINS.BANNERS.getClickValidationToken)
                  )
                    try {
                      i =
            ...
            _hideBanner(), window.AF_SDK.utils.logger(e);
          }
      });
      u.push(r);
    }
    function _showBanner(e) {
      if (((e = e ? e.data : {}), l.any)) {
        ...
        if (((t.style.display = "flex"), "flex" === t.style.display))
          if (s.isSDKDisabled())
            window.AF_SDK.utils.logger(
              "SDK is disabled by query param af-sb-disable."
            );
          else {
            _hideBanner(), i.setAdditionalParams(e.additionalParams);
            var r =
              e.key ||
              (window.AF_SDK.initPluginsConfig.banners &&
                window.AF_SDK.initPluginsConfig.banners.key);
            if (r) {
              var a = { key: r },
              ...
              d && (a.creativeId = d),
                o
                  ? n.getBannerForPreview(a, function (t, r) {
                      if (!t && r && r.length && r[0]) {
                        var i = r[0];
                  ...
                  : n.getBanners(a, function (t, r) {
                      !t &&
                        r &&
                        r.length &&
                        (function _getBannersAssets(e, t, r) {
                          for (var i = 0; i < e.length; i++) {
                            ...
                            window.AF_SDK.utils.logger(
                              "Banner [" +
                                a.id +
                                "] could not be displayed due to it`s frequency cap or dismissal rules"
                            );
                          }
                        })(r, 0, e);
                    });
              ...
              window.AF_SDK.utils.logger(
                "key param must be provided for getting banners from the server"
              );
          }
        else
          window.AF_SDK.utils.logger(
            "We detected a browser that doesn't support flex, displaying banners in this browser is disabled."
          );
      } else
        window.AF_SDK.utils.logger(
          "We detected a non-mobile browser, displaying banners in this browser is disabled."
        );
    }
    function _hideBanner() {
      if (u.length) {
        window.AF_SDK.utils.logger(
          "Removing displayed banner from the page..."
        );
        for (var e = 0; e < u.length; e++) u[e]();
        window.AF_cleanupMethods = u = [];
      }
      i.resetAdditionalParams(), i.resetUpdateParams();
    }
    function _safeExport(e) {
      return Object.keys(e).reduce(function (t, r) {
        return (
          (t[r] = (function _safeExec(e, t) {
    ...
    e.exports = {
      getBanners: function _getBanners(e, t) {
        ...
        if (e && e.key) {
            ...
            window.AF_SDK.xhr({
              ...
              cb: function (r) {
                if (!r || !r.data) {
                  ...
                  return (
                    window.AF_SDK.utils.logger(
                      "Getting creatives for key [" +
                        e.key +
                        "] from the server... received, error: ",
                      n
                    ),
                    t && t({ text: n })
                  );
          ...
          window.AF_SDK.utils.logger(
            "Could not retrieve creatives, no key (mandatory) provided"
          );
      },
      getBannerForPreview: function _getBannerForPreview(e, t) {
        var r = n;
        e && e.key && e.creativeId
          ? window.AF_SDK.xhr({
              method: "GET",
              withCredentials: !1,
          ...
          : window.AF_SDK.utils.logger(
              "Could not retrieve creative, no creativeId/key (mandatory) provided"
            );
      },
  ...
  function (e, t, r) {
    ...
    var i = function (e, t, r) {
      for (var i = 0; i < e.length; i++) {
        var a = new Image(1, 1),
          o = n.timeLimitCallback(
            r,
            function (e) {
              e && "error" === e.type
                ? t("Failed fetching " + e.target.src)
                : t();
            },
            function () {
              t("Request timed out");
        ...
        (a.onload = o), (a.onerror = o), (a.src = e[i]);
      }
    };
    e.exports = {
      prefetchAssets: function _prefetchAssets(e, t) {
        var r =
            window.AF_SDK.utils.getUrlParamsObject({})["af-sb-timeout"] || 1e4,
          a = !1;
        if (0 === e.length) t();
        else {
    ...
    e.exports = {
      render: function _render(e, t) {
        try {
          ...
          throw (window.AF_SDK.utils.logger(e.message), e);
        }
      },
    };
  },
  function (e, t, r) {
    e.exports = { inject: r(7).inject };
  },
  function (e, t, r) {
    "use strict";
    ...
    function _createElement(e, t) {
      ...
      return (r.innerHTML = e), t ? r : r.children[0];
    }
    e.exports = {
      inject: function _inject(e, t, r, n, i) {
        ...
        if (t) {
          ...
          document.head.insertBefore(c, document.head.firstChild), a.push(c);
        }
        switch (n) {
          case "top":
            u.insertBefore(l, u.firstChild), a.push(l);
            break;
          case "top-sticky":
            (l.style.position = "fixed"),
              ...
              ((f = document.createElement("div")).style.height =
                l.offsetHeight + "px"),
              u.insertBefore(f, l),
              a.push(l, f);
            break;
          ...
          case "floating-bottom":
            u.appendChild(l), a.push(l);
        }
        if (r) {
          var _ = _createElement(r, "script");
          document.body.appendChild(_), a.push(_);
        }
  ...
  function (e, t, r) {
    ...
    !(function (r) {
      ...
      e.exports && "undefined" == typeof window
        ? (e.exports = i)
        : e.exports && "undefined" != typeof window
        ? ((e.exports = i()), (e.exports.isMobile = i))
        : ((a = []),
          (n = r.isMobile = i()),
...
!(function (e) {
      ...
      (function () {
        ...
        function init() {
          ...
          window.AF_SDK = window.AF_SDK || {
            CONST: { AF_SESSION: "AF_SESSION" },
            utils: n(3),
            xhr: n(9),
            initPluginsConfig:
              ((e = window.AF.id),
              "string" == typeof e ? { pba: { webAppId: e } } : e),
            BASE: sdkBase(),
            PLUGINS: window.AF.plugins || {},
          };
          var t,
            o,
            i = Object.keys(window.AF_SDK.PLUGINS);
          (window.AF_SDK.Q =
            window.AF && window.AF.q ? window.AF.q.slice(0) : []),
            (window.AF =
              ((t = window.AF_SDK.utils.fingerPrint()),
              (o = (function getSdkVersion() {
                for (var e = 0, t = {}, n = i.length; e < n; e++)
                  window.AF_SDK.PLUGINS[i[e]].VERSION &&
                    (t[i[e]] = window.AF_SDK.PLUGINS[i[e]].VERSION);
                return Object.assign({ BASE: "0.0.54" }, t);
              })()),
              function (e, n, i) {
                if (e && n) {
                  i =
                    arguments.length < 3 ||
                    !arguments[2] ||
                    !window.AF_SDK.utils.isObject(arguments[2])
                      ? window.AF_SDK.utils.createArgObject(arguments[2])
                      : arguments[2];
            ...
            (function initialLoad() {
              for (var e = 0, t = i.length; e < t; e++)
                window.AF(i[e].toLowerCase(), "load", { eventType: "LOAD" });
            })(),
            window.AF_SDK.Q.length &&
              window.AF_SDK.BASE.emptyQ(window.AF_SDK.Q);
        }
        function sdkBase() {
          function returnLogger(e) {
            return window.AF_SDK.utils.logger(e), !1;
          }
          return {
            fetchFunc: function (e, t) {
              ...
              var n = e.toUpperCase();
              return window.AF_SDK.PLUGINS[n]
                ? (window.AF_SDK.PLUGINS[n] && window.AF_SDK.PLUGINS[n][t]) ||
                    window.AF_SDK.BASE[t] ||
                    returnLogger(
                      t +
                        " does not exist in our SDK, please check the documentation"
                    )
                : returnLogger(
                    n +
                      " is missing in AF_SDK, please add this SDK to the snippet"
                  );
            },
            emptyQ: function (e, t) {
              if (e.length)
                for (var n = 0; n < e.length; )
                  e[n].length < 3 ||
                  (window.AF_SDK.PLUGINS[e[n][1].toUpperCase()].emptyQ && !t)
                    ? n++
                    : e[n].length < 3 && t && e[n][1] !== t
                    ? n++
                    : ((e[n][3] = window.AF_SDK.utils.isObject(e[n][3])
                        ? e[n][3]
                        : window.AF_SDK.utils.createArgObject(e[n][3])),
                      window.AF(
                        e[n][1],
                        e[n][2],
                        e[n][3]
  ...
  function (e, t, n) {
    "use strict";
    e.exports = (function () {
      var e = !!getUrlParamsObject({ key: "af-sdk-dev" });
      function getUrlParamsObject(e) {
        if (
          (((e =
            arguments.length <= 0 || !arguments[0]
              ? { search: null }
              : arguments[0]).search = e.hasOwnProperty("search")
            ? e.search
            : location.search),
          ...
          return e.params;
        for (
          var t = ("?" === e.search[0] ? e.search.substr(1) : e.search).split(
              "&"
            ),
            n = 0,
            o = t.length;
          ...
          if (-1 !== t[n].indexOf("=")) {
            ...
            if (
              (i[0].length &&
                (e.params[decodeURIComponent(i[0])] =
                  decodeURIComponent(i[1]) || null),
        ...
        dateUtil: function dateUtil() {
          return (
            ...
            (Date.prototype.addYears = function (e) {
              return this.setYear(this.getFullYear() + e), this;
            }),
            new Date()
          );
        },
  ...
  function (e, t, n) {
    ...
    e.exports = function () {
      ...
      return {
        ...
        locationSearch: window.location
          ? window.location.search
          : "NOT_SUPPORTED",
        locationOrigin: window.location
        ...
        availableScreenResolutionWidth:
          (function availableScreenResolutionWidth() {
        ...
        addBehaviorKey: (function addBehaviorKey() {
          return setResponse(
            (document.body && document.body.addBehavior) || "NOT_SUPPORTED"
          );
        })(),
        ...
        isCanvasSupported: (function isCanvasSupported() {
          ...
          return setResponse(
            (e.getContext && e.getContext("2d")) || "NOT_SUPPORTED"
          );
        })(),
  ...
  function (e, t, n) {
    ...
    e.exports = function () {
      ...
      function createSpan() {
        ...
        return (
          (e.style.cssText =
            "position: absolute; left: -9999px; font-size: 72px; font-style: normal; font-weight: normal; letter-spacing: normal; line-break: auto; line-height: normal; text-transform: none; text-align: left; text-decoration: none; text-shadow: none; white-space: normal; word-break: normal; word-spacing: normal;"),
          (e.innerHTML = n),
          e
        );
      }
      ...
      function isFontAvailable(t) {
        for (var n = !1, o = 0; o < e.length; o++)
          if (
            (n =
              t[o].offsetWidth !== a.width[e[o]] ||
              t[o].offsetHeight !== a.height[e[o]])
          )
            return n;
        return n;
      }
      try {
        var s = (function initializeBaseFontsSpans() {
          for (var t = [], n = 0, o = e.length; n < o; n++) {
            var r = createSpan();
            (r.style.fontFamily = e[n]), i.appendChild(r), t.push(r);
          }
          return t;
        })();
        o.appendChild(i);
        ...
        return o.removeChild(r), o.removeChild(i), d;
      } catch (e) {
  ...
  function (e, t, n) {
    ...
    e.exports = (function () {
      var e =
        "[object Storage]" ===
        Object.prototype.toString.call(window.localStorage);
      function missingKey(e) {
        ...
        return (
          window.AF_SDK.utils.logger(
            "Storage key is missing in localStorage",
            e
          ),
          e || !0
        );
      ...
      function missingLocalService() {
        return window.AF_SDK.utils.logger(
          "localStorage is not being supported by this browser"
        );
      }
      return {
        getItem: e
              ...
              return (
                ...
                (function returnVal(e) {
                  return "[object String]" ===
                    ...
                    window.AF_SDK.utils.isJson(e)
                    ? window.AF_SDK.utils.tcJSON(e, "parse")
                    : e;
                })(localStorage.getItem(e)) ||
                  (function returnDefVal(e, t) {
                    return (
                      window.AF_SDK.utils.logger(
                        "The provided key [" +
                          e +
                          "] returned no value from localStorage, using default value:",
                        t
                      ),
                      t || null
                    );
              ...
              e || missingKey(),
                localStorage.setItem(
                  ...
                  "[object Object]" === Object.prototype.toString.call(t)
                    ? window.AF_SDK.utils.tcJSON(t, "stringify")
                    : t
                );
            }
          : missingLocalService,
        removeItem: e
          ? function (e) {
              e || missingKey(), localStorage.removeItem(e);
            }
          : missingLocalService,
        clearAll: e
          ? function () {
  ...
  function (e, t, n) {
    ...
    e.exports = (function () {
      var e =
        "[object Storage]" ===
        Object.prototype.toString.call(window.sessionStorage);
      function missingKey(e) {
        e =
          arguments.length <= 0 || void 0 === arguments[0]
            ? null
        ...
        return (
          window.AF_SDK.utils.logger(
            "Storage key is missing in sessionStorage",
            e
          ),
          e || !0
        );
      ...
      function missingLocalService() {
        return window.AF_SDK.utils.logger(
          "sessionStorage Storage is not being supported by this browser"
        );
      }
      return {
        getItem: e
                  ...
                  (function returnDefVal(e, t) {
                    return (
                      window.AF_SDK.utils.logger(
                        "The provided key [" +
                          e +
                          "] returned no value from sessionStorage, using default value:",
                        t
                      ),
                      t || null
                    );
        ...
        removeItem: e
          ? function (e) {
              e || missingKey(), sessionStorage.removeItem(e);
            }
          : missingLocalService,
        clearAll: e
          ? function () {
  ...
  function (e, t, n) {
    ...
    e.exports = (function () {
      ...
      function stringifyAttributes(e) {
        var t = "";
        for (var n in e) e[n] && (t += "; " + n + "=" + e[n].split(";")[0]);
        return t;
      }
      function convertType(e, t) {
        return window.AF_SDK.utils.isJson(e)
          ? window.AF_SDK.utils.tcJSON(e, t)
          : e;
      }
      return {
        get: isDocument()
              ...
              return (function rescueCookie(e, t, n) {
                (t =
                  arguments.length <= 1 || void 0 === arguments[1]
                    ...
                    : arguments[1]),
                  (n =
                    arguments.length <= 2 || !arguments[2] ? {} : arguments[2]);
                ...
                return (
                  t &&
                    window.AF_SDK.utils.logger(
                      "[" + t + "] - Doesn't exist in stored cookies",
                      e
                    ),
                  t ? null : n
                );
          ...
          : function (e, t, n) {
              ...
              if (o)
                return (document.cookie =
                  encodeKey(e) +
                  "=" +
                  (function encodeVal(e) {
                    return encodeURIComponent(
                      String(
                        window.AF_SDK.utils.isJson(e)
                          ? window.AF_SDK.utils.tcJSON(e, "stringify")
                          : e
                      )
                    ).replace(
        ...
        remove: isDocument()
          ...
          : function (e) {
              return (document.cookie =
                encodeKey(e) +
                "=" +
                stringifyAttributes(assign({ expires: -1 })));
            },
      };
    })();
  },
  function (e, t, n) {
    ...
    e.exports = (function () {
      ...
      function ajax(e, t, n, o, i, r, a, s) {
        if (!t || !t.length)
          return window.AF_SDK.utils.logger(
            "Cannot perform ajax request, request is missing url",
            arguments
          );
        ...
        c.open(
          ...
          (function setHeaders(e, t, n) {
            Object.keys(
              Object.assign(
                t,
                withBody(n) ? { "Content-type": "text/plain" } : {}
              )
            ).forEach(function (n) {
          ...
          (c.onreadystatechange = function () {
            return 4 !== c.readyState
              ? { status: c.status, text: c.statusText }
              ...
              : s && s({ status: c.status, text: c.statusText });
            var e;
          }),
          withBody(e) ? c.send(JSON.stringify(o)) : c.send(),
          (c.ontimeout = function () {
            return window.AF_SDK.utils.logger(
              "Ajax request was failed because of timeout",
          ...
          (c.onerror = function () {
            return window.AF_SDK.utils.logger(
              "Ajax request was failed because of error",
              Object.assign({}, arguments, {
                status: c.status,
                data: c.responseText,
              })
          ...
          (c.onabort = function () {
            return window.AF_SDK.utils.logger(
              "Ajax request was failed because of abort action",
              Object.assign({}, arguments, {
                status: c.status,
                data: c.responseText,
              })
      ...
      return function () {
        ...
        return s || c || !navigator.sendBeacon
          ? ajax(t, n, o, i, r, a, s, c)
          : (function beacon(e, t) {
